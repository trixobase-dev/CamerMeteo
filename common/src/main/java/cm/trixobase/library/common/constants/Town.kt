...
enum class Town {
    ABONG_MBANG {
        override val region = Region.EST.nom
        override val nom = "Abong-Mbang"
    ...
    AKOM_II {
        ...
        override val nom = "Akom II"
        override val lat = "2.8000"
        override val lon = "10.5667"
        override val picture = R.drawable.iv_town_yaounde
    },
    AKONOLINGA {
        override val region = Region.CENTRE.nom
        override val nom = "Akonolinga"
        override val lat = "3.7737"
        override val lon = "12.2449"
        override val picture = R.drawable.iv_town_yaounde
    },
    AKWAYA {
        override val region = Region.SUD_OUEST.nom
        override val nom = "Akwaya"
    ...
    AMBAM {
        override val region = Region.SUD.nom
        override val nom = "Ambam"
        override val lat = "2.3860"
        override val lon = "11.2722"
        override val picture = R.drawable.iv_town_yaounde
    },
    BAFANG {
        override val region = Region.OUEST.nom
        override val nom = "Bafang"
    ...
    BAHAM {
        override val region = Region.OUEST.nom
        override val nom = "Baham"
        override val lat = "5.3833"
        override val lon = "10.3833"
        override val picture = R.drawable.iv_town_yaounde
    },
    BALI {
        override val region = Region.NORD_OUEST.nom
        override val nom = "Bali"
    ...
    BANGANGTE {
        override val region = Region.OUEST.nom
        override val nom = "Bangangté"
        override val lat = "5.1500"
        override val lon = "10.5333"
        override val picture = R.drawable.iv_town_yaounde
    },
    BANYO {
        override val region = Region.ADAMAOUA.nom
        override val nom = "Banyo"
        override val lat = "6.7485"
        override val lon = "11.8045"
        override val picture = R.drawable.iv_town_douala
    },
    BATOURI {
        override val region = Region.EST.nom
        override val nom = "Batouri"
    ...
    BERTOUA {
        override val region = Region.EST.nom
        override val nom = "Bertoua"
        override val lat = "4.5777"
        override val lon = "13.6844"
        override val picture = R.drawable.iv_town_yaounde
    },
    BOGO {
        override val region = Region.EXTREME_NORD.nom
        override val nom = "Bogo"
    ...
    BUEA {
        override val region = Region.SUD_OUEST.nom
        override val nom = "Buéa"
        override val lat = "4.1568"
        override val lon = "9.2323"
        override val picture = R.drawable.iv_town_yaounde
    },
    DOUALA {
        override val region = Region.LITTORAL.nom
        override val nom = "Douala"
    ...
    DSCHANG {
        override val region = Region.OUEST.nom
        override val nom = "Dschang"
        override val lat = "5.4500"
        override val lon = "10.0500"
        override val picture = R.drawable.iv_town_dschang
    },
    EBOLOWA {
        override val region = Region.SUD.nom
        override val nom = "Ebolowa"
    ...
    FUNDONG {
        override val region = Region.NORD_OUEST.nom
        override val nom = "Fundong"
        override val lat = "6.2833"
        override val lon = "10.3667"
        override val picture = R.drawable.iv_town_yaounde
    },
    GAROUA {
        override val region = Region.NORD.nom
        override val nom = "Garoua"
    ...
    GAROUA_BOULAI {
        override val region = Region.EST.nom
        override val nom = "Garoua-Boulaï"
        override val lat = "5.9000"
    ...
    MEIGANGA {
        override val region = Region.ADAMAOUA.nom
        override val nom = "Meïganga"
        override val lat = "6.5133"
        override val lon = "14.2995"
        override val picture = R.drawable.iv_town_ngaoundere
    },
    MELONG {
        override val region = Region.LITTORAL.nom
        override val nom = "Melong"
